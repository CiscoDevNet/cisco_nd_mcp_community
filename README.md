...
This MCP server acts as a lightweight middleware layer between **Cisco Nexus Dashboard** and any **MCP-compatible client**. It allows an LLM to query fabric health, anomalies, compliance, switches, interfaces, policies, VRFs/networks, and orchestration templates — all through 110 structured MCP tools.
